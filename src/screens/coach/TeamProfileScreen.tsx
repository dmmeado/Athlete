...
type TeamProfileScreenProps = {
  navigation: NativeStackNavigationProp<CoachTeamStackParamList, 'TeamProfile'>;
  route: RouteProp<CoachTeamStackParamList, 'TeamProfile'>;
};

export default function TeamProfileScreen({ navigation, route }: TeamProfileScreenProps) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.actions}>
        ...
        <TouchableOpacity
          style={styles.actionButton}
          onPress={() => navigation.navigate('PlayerNeeds', { teamId })}
        >
          <Ionicons name="person-add" size={20} color={COLORS.primary} />
          <Text style={styles.actionText}>Player Needs</Text>
        </TouchableOpacity>
      </View>
      ...
      {/* Player Needs */}
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Current Player Needs</Text>
        {team.playerNeeds.length > 0 ? (
          ...
          <Text style={styles.emptyText}>No current player needs</Text>
        )}
      </View>
